<template>
	<div class="navbar">
		<div class="title" :style='{"display":"block","height":"44px"}'>
			...
			<span class="title-name" :style='{"padding":"0 0 0 12px","lineHeight":"44px","fontSize":"24px","color":"#fff","float":"left","fontWeight":"500"}'>{{this.$project.projectName}}</span>
		</div>
		<div class="right" :style='{"fontSize":"16px","position":"absolute","right":"7%","top":"8px","display":"flex"}'>
